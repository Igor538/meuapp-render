...
LANGUAGE_CODE = "en-us"  # Você pode ajustar isso para "pt-br" se preferir português
TIME_ZONE = "UTC"  # Ajuste para "America/Sao_Paulo" se estiver no Brasil
...
STATIC_URL = "/static/"
STATIC_ROOT = BASE_DIR / "staticfiles"  # Para produção, coletando arquivos estáticos

# Media files (caso você tenha uploads de arquivos)
MEDIA_URL = "/media/"
